...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\BilletRepository' => function () {
    return ($this->privates['App\Repository\BilletRepository'] ?? $this->load('getBilletRepositoryService.php'));
}, 'App\\Repository\\CommandeRepository' => function () {
    return ($this->privates['App\Repository\CommandeRepository'] ?? $this->load('getCommandeRepositoryService.php'));
}))));
