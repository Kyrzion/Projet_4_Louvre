...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\BilletType' => function () {
    return ($this->privates['App\Form\BilletType'] ?? $this->privates['App\Form\BilletType'] = new \App\Form\BilletType());
}, 'App\\Form\\CommandeType' => function () {
    return ($this->privates['App\Form\CommandeType'] ?? $this->privates['App\Form\CommandeType'] = new \App\Form\CommandeType());
